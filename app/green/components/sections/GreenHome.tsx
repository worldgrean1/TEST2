        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            <div className="space-y-6">
              <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-none tracking-tight flex flex-col sm:flex-row items-center justify-center gap-2 ${
              ...
              <div className="space-y-4">
                <p className="text-lg sm:text-xl typography-h3 text-[#2bb757]">
                  Transforming <span className="text-[#3dd56d] font-semibold">20 Villages</span> into Green Villages by 2030.
                </p>
                <p className={`text-base sm:text-lg max-w-2xl typography-body ${
          ...
          >
            <div className="relative w-full h-96 lg:h-[500px]">
              ...
              >
                <div className="text-2xl font-bold text-[#3dd56d]">280k+</div>
                <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Homes</div>
                <div className="flex items-center mt-1">
